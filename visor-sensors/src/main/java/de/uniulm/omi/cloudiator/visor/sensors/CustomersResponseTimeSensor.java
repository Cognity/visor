 ...
 */
public class CustomersResponseTimeSensor extends AbstractSensor {

    private final static Logger LOG = LoggerFactory.getLogger(RestUtil.class);
    private final String URL_CONFIG = "cp.customersMetrics.url";
    private URL url;
    ...
    protected void initialize(MonitorContext monitorContext,
        ...
        try {
            this.url = new URL(sensorConfiguration.getValue(URL_CONFIG).orElse("http://172.16.12.15:9600/cpmetrics/seconds/10000"));
